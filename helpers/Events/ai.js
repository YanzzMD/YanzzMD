...
export default async function on({ Exp, ev, store, cht, ai, is }) {
    ...
    ev.on({ 
        cmd: ['Zeta', 'zeta','Zetta', 'zetta''autoai', 'aichat', 'ai_interactive'],
        tag: "ai",
        listmenu: ["autoai"]
    }, async () => {
        function sendAiInfo(){
          Exp.sendMessage(id, {
            ...
            contextInfo: { 
                externalAdReply: {
                    ...
                    thumbnailUrl: "https://i.ibb.co.com/5Wd31yg/IMG-20240817-WA0352.jpg",
                    sourceUrl: "Made By YanzzOfficial",
                    mediaUrl: `http://ẉa.me/6282245186794/9992828`,
        ...
        let set = {
            "on": {
                "done": "Berhasil!, Zetta Ai telah diaktifkan dalam chat ini!",
                "value": true
            },
            "off": {
                "done": "Berhasil!, Zetta Ai telah dimatikan dalam chat ini!",
                "value": false
            },
            "on-group": {
                "done": "Berhasil!, Zetta Ai telah diaktifkan di semua grup!",
                "owner": true,
                "for": from.group,
                "value": true
            },
            "on-private": {
                "done": "Berhasil!, Zetta Ai telah diaktifkan di semua chat private!",
                "owner": true,
                "for": from.sender,
                "value": true
            },
            "off-group": {
                "done": "Berhasil!, Zetta Ai telah dimatikan di semua chat group!",
                "owner": true,
                "for": from.group,
                "value": false
            },
            "off-private": {
                "done": "Berhasil!, Zetta Ai telah dimatikan di semua chat private!",
                "owner": true,
                "for": from.sender,
                "value": false
            },
            "on-all": {
                "done": "Berhasil!, Zetta Ai telah diaktifkan di semua chat!",
                "owner": true,
                "for": "all",
                "value": true
            },
            "off-all": {
                "done": "Berhasil!, Zetta Ai telah dimatikan di semua chat!",
                "owner": true,
                "for": "all",
                "value": false
            },
            "on-energy": {
                "done": "Berhasil!, sekarang Limit bisa didapatkan dari interaksi!",
                "owner": true,
                "type": "energy",
                "value": true
            },
            "off-energy": {
                "done": "Berhasil!, sekarang Limit tidak akan bisa di dapat dari interaksi!",
                "owner": true,
                "type": "energy",
                "value": false
            }
